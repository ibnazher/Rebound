            ...
            using (var savedata = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (e.Id != 0)
                    {
                        ...
                        if (e.BillingStatus.ToString() == "Pending") { s.Color = "orange"; }
        ...
        public JsonResult CancelReservation(int id)
        {
            ...
            using (ApplicationDbContext db = new ApplicationDbContext())
            {
                if (id != 0)
                {
                    ...
                    t.Narration = s.ScheduleTitle + " - " + s.StartedAt.ToString() + " to " + s.EndAt.ToString();
                    ...
                    c.Balance = Convert.ToDecimal(cBalance) + (s.Price + Convert.ToDecimal(s.ExtraitemPrice));
                    db.Entry(c).State = EntityState.Modified;
                    ...
                    if (e.Fromdate != null)
                    {
                        ...
                        if (e.Advancereservation == true)
                        {
                            ...
                            foreach (var re in r)
                            {
                                ...
                                if (re.BillingStatus.ToString() == "Pending" || re.BillingStatus.ToString() == null) { re.Color = "orange"; }
                                if (e.Price != 0)
                                {
                        ...
                        else
                        {
                            ...
                            if (e.BillingStatus.ToString() == "Pending" || e.BillingStatus.ToString() == null) { e.Color = "orange"; }
